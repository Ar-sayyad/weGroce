...
<!--                <p class="rev">
 ...
 <script>           
         function filterCategoryProduct(){
            ...
            $.post("<?php echo base_url();?>Category/filterCategoryProduct", { categoryId : category, priceId : price  }, function(data){
               // alert(data); 
             	if(data){
         ...
         function filterPriceProduct(){
            ...
            $('.prod_filtering').fadeIn();
            $('.loadproducts').css('opacity','0.2');
            $.post("<?php echo base_url();?>Category/filterPriceProduct", { priceId : price  }, function(data){
               // alert(data);
             	if(data){
                     $('.prod_filtering').fadeOut();
                      $('.loadproducts').html(data);
