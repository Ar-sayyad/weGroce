...
<!-- Document Title -->
<title>Mera Trainer | Online Training site </title>

<!-- Favicon -->
<link rel="shortcut icon" href="<?php echo base_url();?>home/images/favicon.ico" type="image/x-icon">
<link rel="icon" href="<?php echo base_url();?>home/images/favicon.ico" type="image/x-icon">
...
<!--  <div class="top-bar">
  ...
  <header>
    <div class="container">
      <div class="logo">
          <a href="index-2.html">
              <img src="<?php echo base_url();?>home/images/logo.png" alt="" >
          </a> 
      </div>
      ...
      <ul class="nav navbar-right cart-pop">
        <li class="dropdown"> 
            <a href="#" style="color: #ededed;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                <span class="itm-cont">3</span> <i class="flaticon-shopping-bag"></i> <strong>My Cart</strong> <br>
          <span>3 item(s) - $500.00</span>
            </a>
          <ul class="dropdown-menu">
            <li>
              <div class="media-left"> <a href="#." class="thumb"> <img src="<?php echo base_url();?>home/images/item-img-1-1.jpg" class="img-responsive" alt="" > </a> </div>
              <div class="media-body"> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> <span>250 x 1</span> </div>
            </li>
            <li>
              <div class="media-left"> <a href="#." class="thumb"> <img src="<?php echo base_url();?>home/images/item-img-1-2.jpg" class="img-responsive" alt="" > </a> </div>
              ...
              <div class="dropdown-menu animated-2s fadeInUpHalf">
                <div class="mega-inside">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4"> <img class=" nav-img" src="<?php echo base_url();?>home/images/navi-img.png" alt="" > </div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="tp-banner">
                <ul>
                  ...
                  <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
                    <!-- MAIN IMAGE --> 
                    <img src="<?php echo base_url();?>home/images/slider-img-1.jpg"  alt="slider"  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat"> 
                  ...
                  <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
                    <!-- MAIN IMAGE --> 
                    <img src="<?php echo base_url();?>home/images/slider-img-3.jpg"  alt="slider"  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat"> 
        ...
        <div class="tab-content"> 
          ...
          <div role="tabpanel" class="tab-pane active fade in" id="featur"> 
            ...
            <div class="item-slide-5 with-nav"> 
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-1.jpg" alt="" > 
                  <!-- Content --> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-2.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-3.jpg" alt="" > 
                  <!-- Content --> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-4.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-5.jpg" alt="" > 
                  <!-- Content --> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-6.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-7.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-8.jpg" alt="" > <span class="new-tag">New</span> 
          ...
          <div role="tabpanel" class="tab-pane fade" id="special"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-11.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Latop</span> <a href="#." class="tittle">Laptop Alienware 15 i7 Perfect For Playing Game</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-9.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-8.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-7.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-6.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
          ...
          <div role="tabpanel" class="tab-pane fade" id="on-sal"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-1.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-2.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-5.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-4.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
        ...
        <div class="tab-content"> 
          ...
          <div role="tabpanel" class="tab-pane active fade in" id="tv-au"> 
            ...
            <div class="item-slide-5 with-bullet no-nav"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-10.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-11.jpg" alt="" > <span class="new-tag">New</span> 
          ...
          <div role="tabpanel" class="tab-pane fade" id="smart"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-11.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-17.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-15.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
          ...
          <div role="tabpanel" class="tab-pane fade" id="deks-lap"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-13.jpg" alt="" > <span class="new-tag">New</span> 
          ...
          <div role="tabpanel" class="tab-pane fade" id="game-com"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-3.jpg" alt="" > <span class="new-tag">New</span> 
          ...
          <div role="tabpanel" class="tab-pane fade" id="watches"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-8.jpg" alt="" > <span class="sale-tag">-25%</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-9.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-17.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-16.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-12.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
          ...
          <div role="tabpanel" class="tab-pane fade" id="access"> 
            ...
            <div class="item-col-5"> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-16.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Reloj Inteligente Smart Watch M26 Touch Bluetooh </a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <span class="margin-left-10">5 Review(s)</span></p>
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-15.jpg" alt="" > <span class="new-tag">New</span> 
              ...
              <!-- Product -->
              <div class="product">
                <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/item-img-1-14.jpg" alt="" > 
                  <!-- Content --> 
                  <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Ebook 7" 128GB full HD</a> 
                  <!-- Reviews -->
                  <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span></p>
    ...
    <section class="padding-top-60 padding-bottom-60">
      <div class="container"> 
        ...
        <div id="blog-slide" class="with-nav"> 
          ...
          <!-- Blog Post -->
          <div class="blog-post">
            <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/blog-img-1.jpg" alt="" > <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">It’s why there’s nothing else like Mac. </a>
          ...
          <!-- Blog Post -->
          <div class="blog-post">
            <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/blog-img-2.jpg" alt="" > <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">Get the power to take your business to the
              next level. </a>
              <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi [...] </p>
              <a href="#.">Readmore</a> </article>
          </div>
          ...
          <!-- Blog Post -->
          <div class="blog-post">
            <article> <img class="img-responsive" src="<?php echo base_url();?>home/images/blog-img-3.jpg" alt="" > <span><i class="fa fa-bookmark-o"></i> 25 Dec, 2017</span> <span><i class="fa fa-comment-o"></i> 86 Comments</span> <a href="#." class="tittle">It’s why there’s nothing else like Mac. </a>
              <p>Etiam porttitor ante non tellus pulvinar, non vehicula lorem fermentum. Nulla vitae efficitur mi [...] </p>
              <a href="#.">Readmore</a> </article>
          </div>
        </div>
...
<!--    <section class="light-gry-bg clients-img">
      <div class="container">
        <ul>
          <li><img src="<?php echo base_url();?>home/images/c-img-1.png" alt="" ></li>
          <li><img src="<?php echo base_url();?>home/images/c-img-2.png" alt="" ></li>
          <li><img src="<?php echo base_url();?>home/images/c-img-3.png" alt="" ></li>
          <li><img src="<?php echo base_url();?>home/images/c-img-4.png" alt="" ></li>
          <li><img src="<?php echo base_url();?>home/images/c-img-5.png" alt="" ></li>
        </ul>
      </div>
    </section>-->
...
<!--       <section class="newslatter">
  ...
  <!-- Footer -->
 <footer style="background-color: #121921;color: rgba(255,255,255,.7);">
    <div class="container"> 
      ...
      <div class="row"> 
        ...
        <div class="col-lg-5 col-md-12 p-r-5">
         <p><img src="<?php echo base_url();?>home/images/logo.png" alt="" ></p>
          <p><strong>MeraTrainer - Everything About Training</strong> is an endeavour to connect learners and training providers with various options and tools.</p>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <ul class="links-footer">
            <li><i class="fa fa-mobile-alt"></i><a href="#.">+91 7878 111 999</a></li>
            <li><a href="#."><i class="ti-mobile"></i> info@meratrainer.com</a></li>
            <li><a href="#."><b>Office</b><br/>401 Siddhi-A, Sanskar Park, B/H China Gate-2, New City Light Surat, Gujarat 395007 India</a></li>
     ...
     <!--  <div class="row" style="margin-top:2%"> -->
      <!--   <div class="col-sm-6"> -->
         <!--  <p style="text-align:center">Copyright Â© 2017 <a href="#." class="ri-li"> SmartTech </a>HTML5 template. All rights reserved</p>
        </div> -->
  ...
  <div class="rights">
    <div class="container">
      <div class="row">
        <!-- <div class="col-sm-6"> -->
          <p style="text-align:center;color: #312828;font-weight: 600;text-transform: capitalize;">Copyright &copy; 2018  MeraTrainer. All rights reserved</p>
        </div>
       <!--  <div class="col-sm-6 text-right"> <img src="images/card-icon.png" alt=""> </div> -->
      </div>
    </div>
...
<script src="<?php echo base_url();?>home/js/vendors/wow.min.js"></script> 
<script src="<?php echo base_url();?>home/js/vendors/bootstrap.min.js"></script> 
<script src="<?php echo base_url();?>home/js/vendors/own-menu.js"></script> 
<script src="<?php echo base_url();?>home/js/vendors/jquery.sticky.js"></script> 
<script src="<?php echo base_url();?>home/js/vendors/owl.carousel.min.js"></script> 

<!-- SLIDER REVOLUTION 4.x SCRIPTS  --> 
<script type="text/javascript" src="<?php echo base_url();?>home/rs-plugin/js/jquery.tp.t.min.js"></script> 
<script type="text/javascript" src="<?php echo base_url();?>home/rs-plugin/js/jquery.tp.min.js"></script> 
