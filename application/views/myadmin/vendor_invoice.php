    ...
    <div class="panel-body no-padding-bottom"  >
                                   ...
                                   <div class="col-md-12">
                                                  <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="float: right">
                                                            <h5 class="text-uppercase text-semibold">Invoice #AQ00<?php echo $row['order_id'];?></h5>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><span><img width="60px"  src="<?php echo base_url().'assets/uploads/products/'.$img_path;?>"></span></td>
