                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="login-content">                       
                        <div class="login-form">
                            ...
                            <form method="post" action="<?php echo base_url().'Login/otpverify';?>">
                                <div class="form-group">
                                    <label>OTP</label>
                                    <input type="text" id="code" class="form-control" placeholder="code" name="code">
                                   <input type="hidden" id="mobileToken" class="form-control" placeholder="mobile" name="mobileToken" value="<?php echo $register_info['data'];?>">
                                   <input type="hidden" id="phoneNumber" class="form-control" placeholder="mobile" name="phoneNumber" value="<?php echo $this->session->userdata('log_trainer_mobile');?>">
                                </div>
