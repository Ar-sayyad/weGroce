                          ...
                          <div class="col-md-12 col-sm-12">
                            <div class="login-area-form login">
                              ...
                              <div class="form-fields">
                                  ...
                                  <input type="hidden" id="username" value="<?php echo $param2;?>"/>
                                  <input type="hidden" id="contact" value="<?php echo $param3;?>"/>
...
<script>
   ...
   //   alert("hi");
        ...
        $contact = $("#contact").val();
         ...
         $.post("<?php echo base_url();?>Admin/checkOrderStatus", { drivername:$drivername, mobile:$mobile, vehicle_no:$vehicle_no }, function(data){

            if(data==1){
                                    
                                    $.post("<?php echo base_url();?>Vendors/changeOrderStatus", { drivername:$drivername, mobile:$mobile, vehicle_no:$vehicle_no, order_id: $order_id, order_status:4, username:$username, contact:$contact }, function(data){
