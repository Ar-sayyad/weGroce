<?php
$sites_info = $this->db->get_where('otp', array('otp_id' => $param2))->result_array();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Adminity/generateOtp/update/<?php echo $row['otp_id'];?>" method="post">   
                                <div class="row">
                                    <div class="col-md-3">
