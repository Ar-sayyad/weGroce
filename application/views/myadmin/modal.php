        ...
        <div class="modal-dialog" >
            <div class="modal-content" style="width: 90%;">
                ...
                <div class="modal-header">               
                    ...
                    <h4 class="modal-title" style="color: #ff0582;font-size: 20px;font-weight: 600;"><img style="width: 50px;" src="<?php echo base_url();?>home/images/img/favicon.png"> WeGrocers.com</h4>
                </div>
