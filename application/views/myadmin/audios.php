               ...
               <!---page title-->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="addbtn">
                                <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>Admin/popup/myadmin/addAudio');" class="btn btn-danger" >Add Audio</button>
                             </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Admin/popup/myadmin/viewAudio/<?php echo $row->product_id;?>');" class="table-link">
                                                        <span  class="fa-stack">
                                                        ...
                                                        <!--<a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Admin/popup/myadmin/editVideo/<?php echo $row->product_id;?>');" class="table-link">
                                                        <span  class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>Admin/audios/delete/<?php echo $row->product_id;?>" class="table-link danger">
