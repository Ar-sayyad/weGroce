               ...
               <!---page title-->
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="addbtn">
                                <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>Admin/popup/myadmin/addSuitable');" class="btn btn-primary" >Add Suitable</button>
                             </div>
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo ($row->suitable_name);?></td>
                                                    <td style="text-align: left">
                                                       <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Admin/popup/myadmin/editSuitable/<?php echo $row->suitable_id;?>');" class="table-link">
                                                        <span  class="fa-stack">
