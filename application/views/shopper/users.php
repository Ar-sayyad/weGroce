                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Trainerdashboard/popup/trainer/viewUser/<?php echo $row->id;?>');" class="table-link">
                                                        <span  class="fa-stack">
...
<!--                                                        <a style="cursor:pointer" onclick="showAjaxModal('<?php echo base_url();?>Trainerdashboard/popup/trainer/editUser/<?php echo $row->id;?>');" class="table-link">
                                                        <span  class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
                                                        ...
                                                        <!--<a  href="<?php echo base_url(); ?>Trainerdashboard/users/delete/<?php echo $row->id;?>" class="table-link danger">
