                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card alert">
                                ...
                                <form action="<?php echo base_url();?>Trainerdashboard/videos/addVideo" method="post" enctype="multipart/form-data">   
                                    <div class="row">
                                         <div class="col-md-4"> 
                                            <div class="form-group">
                                                <label>Type<span style="color:red;">*</span></label>  
                                                    <select name="product_type" onchange="showhide()" class="chosen-select form-control" required="" > 
                                  ...
                                  function showhide()
                                       {
                                           var video = document.getElementById("show_video");
                                            var audio = document.getElementById("show_audio");
...
//                                              audio.style.display = "none";
                                       ...
                                       <!--  <div class="col-md-4"> 
                                        ...
                                        <div class="col-md-4" > 
                                            <div class="form-group" id="show_audio" >                           
                                           ...
                                           <div class="col-md-4" > 
                                            <div class="form-group" id="show_video" >                           
                                                 <label>Upload Video<span style="color:red"></span></label> 
                                                 <input type="file" name="videofile" accept="video/*" class="form-control border-none input-flat bg-ash" placeholder="Media file">
                                            </div> 
                                         </div> 
