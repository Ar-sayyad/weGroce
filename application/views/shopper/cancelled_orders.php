                                            ...
                                            <tbody>
                                               ...
                                               <?php $sr=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
    <select class="form-control order_status" style="width:165px" data-id="<?php echo $row['order_id'];?>" name="order_status">
        <option value="1"<?php if($row['order_status']==1){echo"selected";}elseif($row['order_status']>=1){echo"disabled";} ?>>Order Placed</option>
        <option value="2"<?php if($row['order_status']==2){echo"selected";}elseif($row['order_status']>=2){echo"disabled";}  ?>>Processing</option>
        <option value="3"<?php if($row['order_status']==3){echo"selected";}elseif($row['order_status']>=3){echo"disabled";}  ?>>Delivery Assigned</option>
        <option value="4"<?php if($row['order_status']==4){echo"selected";}elseif($row['order_status']>=4){echo"disabled";}  ?>>Out for Delivery</option>
        <option value="5"<?php if($row['order_status']==5){echo"selected";}elseif($row['order_status']>=5){echo"disabled";}  ?>>Delivered</option>
        <option value="6"<?php if($row['order_status']==6){echo"selected";}elseif($row['order_status']==5){echo"disabled";}  ?>>Cancelled</option>
